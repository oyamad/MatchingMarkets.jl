...
{
    "location": "index.html#MatchingMarkets.jl-1",
    "page": "Home",
    "title": "MatchingMarkets.jl",
    "category": "section",
    "text": "Matching algorithms in Julia.CurrentModule = MatchingMarkets\nDocTestSetup  = quote\n    using MatchingMarkets\nend"
},

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "This is an unregistered package. To install, open a Julia session and typePkg.clone(\"https://github.com/oyamad/MatchingMarkets.jl\")"
},

{
    ...
    "title": "Usage",
    "category": "section",
    "text": "After installation, you can use this package byusing MatchingMarkets"
},
...
{
    "location": "lib/public.html#MatchingMarkets.deferred_acceptance-Tuple{Array{Int64,2},Array{Int64,2},Array{Int64,1},Array{Int64,1}}",
    "page": "Public Interface",
    "title": "MatchingMarkets.deferred_acceptance",
    "category": "Method",
...
{
    "location": "lib/public.html#MatchingMarkets.deferred_acceptance-Tuple{Array{Int64,2},Array{Int64,2}}",
    "page": "Public Interface",
    "title": "MatchingMarkets.deferred_acceptance",
    "category": "Method",
...
{
    "location": "lib/public.html#MatchingMarkets.deferred_acceptance-Union{Tuple{Array{Int64,2},Array{Int64,2},Array{Int64,1},Type{P}}, Tuple{Array{Int64,2},Array{Int64,2},Array{Int64,1}}, Tuple{P}} where P<:MatchingMarkets.DAProposal",
    "page": "Public Interface",
    "title": "MatchingMarkets.deferred_acceptance",
    "category": "Method",
...
{
    "location": "lib/public.html#MatchingMarkets.random_prefs-Tuple{AbstractRNG,Integer,Integer}",
    "page": "Public Interface",
    "title": "MatchingMarkets.random_prefs",
    "category": "Method",
...

{
    ...
    "title": "Public Interface",
    "category": "section",
    "text": "Modules = [MatchingMarkets]\nPrivate = false"
},

{
    "location": "lib/internals.html#",
    "page": "Private Internals",
...
{
    "location": "lib/internals.html#MatchingMarkets._randperm!-Union{Tuple{AbstractRNG,AbstractArray{T,1}}, Tuple{T}} where T<:Integer",
    "page": "Private Internals",
    "title": "MatchingMarkets._randperm!",
    "category": "Method",
    "text": "Given a vector a of length n, generate a random permutation of length n and store it in a.\n\n\n\n"
},

{
    "location": "lib/internals.html#MatchingMarkets._randperm2d!-Union{Tuple{AbstractRNG,AbstractArray{T,2}}, Tuple{T}} where T<:Integer",
    "page": "Private Internals",
    "title": "MatchingMarkets._randperm2d!",
    "category": "Method",
    "text": "Given an m x n matrix a, generate n random permutations of length m and store them in columns of a.\n\n\n\n"
},

{
    "location": "lib/internals.html#MatchingMarkets.rand_lt",
    "page": "Private Internals",
    "title": "MatchingMarkets.rand_lt",
    "category": "Function",
    "text": "Return a random Int (masked with mask) in 0 n), when n <= 2^52.\n\n\n\n"
},

{
    "location": "lib/internals.html#Private-Internals-1",
    "page": "Private Internals",
    "title": "Private Internals",
    "category": "section",
    "text": "Modules = [MatchingMarkets]\nPublic = false"
